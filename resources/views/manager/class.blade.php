                ...
                <div class="col-md-12">
                    <section class="task-panel tasks-widget">
                        <div class="panel-heading">
                            <div class="pull-left"><h5><i class="fa fa-tasks"></i>班级列表</h5></div>
                            <br>
                        </div>
                            ...
                            <div class="task-content">
                                ...
                                <ul class="task-list">
                                    @foreach($data as $class)
                                        <li id="student_{{$class->id}}">
                                            <div class="task-title">
                                                <span class="hidden span-id task-title-sp">{{$class->id}}</span>
                                                <span class="span-name task-title-sp">{{$class->name}}</span>
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal tasi-form" method="post" action="/manager/createClass">
