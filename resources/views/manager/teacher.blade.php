    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a class="active" href="/manager/teacher">
                ...
                <div class="col-md-12">
                    <section class="task-panel tasks-widget">
                        <div class="panel-heading">
                            <div class="pull-left"><h5><i class="fa fa-tasks"></i>教师列表</h5></div>
                            <br>
                        </div>
                            ...
                            <div class="task-content">
                                ...
                                <ul class="task-list">
                                    @foreach($data as $teacher)
                                        <li id="student_{{$teacher->id}}">
                                            <div class="task-title">
                                                <span class="hidden span-id task-title-sp">{{$teacher->id}}</span>
                                                <span class="span-name task-title-sp">{{$teacher->name}}</span>
                                                <span class="span-sex task-title-sp">{{$teacher->sex==0?'男':'女'}}</span>
                                                <span class="span-age task-title-sp">{{$teacher->age}}</span>
                                                <span class="span-mobile task-title-sp">{{$teacher->mobile}}</span>
                                                <div class="pull-right hidden-phone">
                                                    <button id="{{$teacher->id}}"
                                                            class="btn btn-primary btn-xs btn-update"><i
                                                                class="fa fa-pencil"></i>
                                                    </button>
                                                    <a href="deleteTeacher/{{$teacher->id}}"
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> 添加／更新教师</h4>
                                <form class="form-horizontal tasi-form" method="post" action="/manager/createTeacher">
                                    ...
                                    <div class="form-group has-warning">
                                        <label class="col-sm-2 control-label col-lg-2" for="inputWarning">手机号</label>
                                        <div class="col-lg-10">
...
<script type="application/javascript">
    $('.btn-update').click(function () {
        ...
        $('#mobile').val($(this).parent().prevAll('.span-mobile').text());
    });
