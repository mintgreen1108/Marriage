    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="mt">
                    <a class="active" href="/teacher/score">
                        <i class="fa fa-dashboard"></i>
                        <span>学生成绩录入</span>
                    </a>
                </li>
                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <h4 class="mb"><i class="fa fa-angle-right"></i> 成绩录入</h4>
                                <form class="form-horizontal tasi-form" method="post" action="/teacher/createScore">
                                    <input id="user_id" type="text" name="id" class="form-control hidden">
                                    <div class="form-group has-success">
                                        <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">学号</label>
                                        <div class="col-lg-10">
                                            <input id="user_name" type="number" name="student_id" class="form-control"
                                                   required>
                                        </div>
                                    </div>

                                    <div class="form-group has-success">
                                        <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">课程</label>
                                        <div class="col-lg-10">
                                            <select id="course_id" name="course_id" size="1" class="sel">
                                                <option>请选择课程</option>
                                                @foreach($data as $score)
                                                    <option class="option"
                                                            value="{{$score->course_id}}">{{$score->course}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group has-success">
                                        <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">分数</label>
                                        <div class="col-lg-10">
